...
function SvgMap(props) {
    ...
    const med = <svg width="100%" height="100%">
                    <line x1="51%" y1="57%" x2="71%" y2="72%" style={{"stroke": "#F3E9D2", "stroke-width": "2", "stroke-dasharray": "10"}} />
                    <line x1="21%" y1="91%" x2="72%" y2="73%" style={{"stroke": "#F3E9D2", "stroke-width": "2", "stroke-dasharray": "10"}} />
                </svg>;
