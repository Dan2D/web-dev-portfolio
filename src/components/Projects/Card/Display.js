...
function Display(props) {
    return (
        <div className="proj-view">
            ...
            <img className="desktop-img" src={require(`../../../images/views/${props.desktop}.png`)} alt="desktop-view"/>
            <img className="proj-view__mobile" src={require(`../../../images/views/mobile-view.png`)} alt="mobile-view"/>
            <img className="mobile-img" src={require(`../../../images/views/${props.mobile}.png`)} alt="mobile-view"/>
        </div>
    )
}
